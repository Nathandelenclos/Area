...
import { Pressable, StyleSheet, DimensionValue, SafeAreaView, ScrollView, Text, Modal, TouchableOpacity, View } from 'react-native';
...
import { faClone, faE, faEdit, faHeart, faToggleOff, faToggleOn, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
...
function AppletBubble({ appletTitle, description, color, size }: AppletBubbleProps): React.JSX.Element {
...
export default function InfoApplet({id = 1} : {id?: number}): JSX.Element {
    ...
    [
      {
        ...
        description: [
          "Send an email to “simon.riembault@epitech.eu”",
        ],
        ...
        description: [
          "J'aime le crane de Frankeinstein #Noa",
        ],
        color: color.mainColor,
        size: "reaction",
      },
  ...
  console.log(settingsList[2].isActive);
