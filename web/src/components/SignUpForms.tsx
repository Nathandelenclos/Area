...
function SignUpForms() {
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <p className='w-3/5 mb-5'>By creating an account you accept our <a className='text-[#7A73E7]'>Terms of services</a> and <a className='text-[#7A73E7]'>Privacy policy</a>.</p>
    </div>
  )
}
